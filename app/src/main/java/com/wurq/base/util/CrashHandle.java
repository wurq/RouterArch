...
import com.wurq.routerarch.config.ServEnv;
...
//                        }
    ...
    private boolean handleException(Throwable ex) {
        ...
        new Thread() {
            ...
            public void run() {
                Looper.prepare();
                com.wurq.base.util.ToastUtil.makeShortToast(R.string.crash_warning);
                Looper.loop();
            }
        }.start();
        //收集设备参数信息
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        sb.append(result);
        try {
            long timestamp = com.wurq.base.util.SystemUtil.getCurrentTimeMillis();
            String time = formatter.format(new Date());
            String fileName = "crash-"+ com.wurq.base.util.ProcessUtil.getCurrentProcessName() + time + "-" + timestamp + ".txt";
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                String path = com.wurq.base.util.StorageUtil.getWritePath(fileName, StorageType.TYPE_CRASH);
